...
public class CompareListHelper implements CompareListAdapter.OnItemListener{
    ...
    public CompareListHelper(RecyclerView calendarRecyclerView,
    ...
    public void setMonthView() {
        ...
        CompareListAdapter compareListAdapter = new CompareListAdapter(dates,this,context);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(context,7);
        calendarRecyclerView.setLayoutManager(layoutManager);
        calendarRecyclerView.setAdapter(compareListAdapter);
        //月份列表配置。
    }//配置界面显示。
